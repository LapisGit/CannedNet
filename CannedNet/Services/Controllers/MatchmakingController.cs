...
public class MatchmakingController : ControllerBase
{
    ...
    public async Task<IResult> GotoRoom(string room, HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
    ...
    public async Task<IResult> PlayerHeartbeat(HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public IResult PlayerStatusVisibility()
    {
        return Results.Ok();
    }

    [HttpPost("/roominstance/{id}/reportjoinresult")]
    public IResult ReportJoinResult(string id)
    {
        return Results.Ok();
    }
}
