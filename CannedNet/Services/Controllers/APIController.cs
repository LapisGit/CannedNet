...
public class APIController : ControllerBase
{
    ...
    private readonly StorefrontFillService _storefrontService;
    private readonly NotificationService _notificationService;

    public APIController(JwtTokenService jwtService, StorefrontFillService storefrontService, NotificationService notificationService)
    {
    ...
    public IResult GetAmplitudeConfig() => Results.Ok(new
    {
        AmplitudeKey = "a",
        StatSigKey = "a",
        RudderStackKey = "a",
    ...
    [HttpGet("config/v2")]
    public IResult GetConfigV2() => Results.Content(System.IO.File.ReadAllText("JSON/configv2.json"), "application/json");

    [HttpGet("versioncheck/v4")]
    public IResult GetVersionCheck() => Results.Content("{\"VersionStatus\":0}", "application/json");

    [HttpGet("gameconfigs/v1/all")]
    public IResult GetGameConfigs() => Results.Content(System.IO.File.ReadAllText("JSON/gameconfigs.json"), "application/json");

    [HttpGet("relationships/v2/get")]
    public IResult GetRelationships() => Results.Content("[]", "application/json");

    [HttpGet("messages/v2/get")]
    public IResult GetMessages() => Results.Content("[]", "application/json");

    [HttpGet("playerReputation/v1/{id}")]
    public IResult GetPlayerReputation(string id) =>
    ...
    public IResult GetPlayerProgression(string id) =>
        Results.Content($"{{\"PlayerId\":{id},\"Level\":1,\"XP\":0}}", "application/json");

    [HttpPost("playerReputation/v1/bulk")]
    public async Task<IResult> BulkPlayerReputation(HttpRequest httpRequest, AppDbContext db)
    {
        ...
        var json = System.IO.File.ReadAllText("JSON/bulkprogression.json");
        return Results.Content(json, "application/json");
    }

    [HttpPost("players/v1/progression/bulk")]
    public async Task<IResult> BulkPlayerProgression(HttpRequest httpRequest, AppDbContext db)
    {
        var ids = await ParseFormIds(httpRequest);
    ...
    public async Task<IResult> BulkProgression(HttpRequest httpRequest, AppDbContext db)
    {
        var ids = await ParseFormIds(httpRequest);
    ...
    public async Task<IResult> GetAvatarItems(HttpRequest request, AppDbContext db)
    {
        ...
        var accountId = _jwtService.ValidateAndGetAccountId(token);
    ...
    [HttpGet("avatar/v2")]
    public async Task<IResult> GetAvatar(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> SetAvatar(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetSavedOutfits(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetVoteToKickReasons(HttpRequest request, AppDbContext db)
    {
    ...
    [HttpGet("settings/v2")]
    public async Task<IResult> GetSettings(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetUnlockedEquipment(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetUnlockedConsumables(HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
        var authHeader = request.Headers.Authorization.ToString();
        if (string.IsNullOrEmpty(authHeader) || !authHeader.StartsWith("Bearer ", StringComparison.OrdinalIgnoreCase))
            return Results.Unauthorized();
    ...
    [HttpGet("objectives/v1/myprogress")]
    public async Task<IResult> GetMyProgress(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
    ...
    public async Task<IResult> GetAvatarGifts(HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
        try
        {
            var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetPendingGameRewards(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
        return Results.Content("[]", "application/json");
    }
    ...
    public async Task<IResult> GetCommunityBoard(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetPlayerEvents(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
    ...
    public async Task<IResult> UpdateAndGetSubscription(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetBalance(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetP2PBetaEnabled(HttpRequest request, AppDbContext db)
    {
        return Results.Content("false", "application/json");
    }

    [HttpGet("announcement/v1/get")]
    public async Task<IResult> GetAnnouncement(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetMyRoomKeys(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
        return Results.Content("[]", "application/json");
    }
    ...
    public async Task<IResult> GetQuickPlay(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
    ...
    public async Task<IResult> GetRoomKeys(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
    ...
    public async Task<IResult> GetBio(HttpRequest request, AppDbContext db)
    {
        var authHeader = request.Headers.Authorization.ToString();
    ...
    [HttpPost("accounts/v1/forplatformids")]
    public async Task<IResult> ForPlatformIds(HttpRequest request, AppDbContext db)
    {
        request.EnableBuffering();
        request.Body.Position = 0;
        using var reader = new StreamReader(request.Body);
    ...
    public async Task<IResult> GetGiftDropStore3(HttpRequest request, AppDbContext db)
    {
        var storefronts = await _storefrontService.GetStorefrontsAsync();
    ...
    public async Task<IResult> GetCurrentChallenge(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetBulkRooms(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetHotRooms(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetHotRoomsAndPlaylists(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetMyCreatedRooms(HttpRequest request, AppDbContext db)
    {
        // TODO ADD FUNCTIONALITY
    ...
    public async Task<IResult> GetRoom(HttpRequest request, AppDbContext db, string id)
    {
        // this sucked to do
    ...
    public async Task<IResult> GetNamedImages(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> UpdateObjective(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> Hile(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetGiftDropStore300(HttpRequest request, AppDbContext db)
    {
        var storefronts = await _storefrontService.GetStorefrontsAsync();
    ...
    public async Task<IResult> GetGiftDropStore2(HttpRequest request, AppDbContext db)
    {
        var storefronts = await _storefrontService.GetStorefrontsAsync();
    ...
    public async Task<IResult> BuyItem(HttpRequest request, [FromBody] BuyItemRequest buyRequest, AppDbContext db, JwtTokenService jwtService)
    {
        try
        {
            var authHeader = request.Headers.Authorization.ToString();
            ...
            try
            {
                var purchaseNotification = _notificationService.CreateNotification(
                ...
                await _notificationService.SendNotificationToPlayer(id, purchaseNotification);
            }
    ...
    public async Task<IResult> GenerateGift(HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
        try
        {
            var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> ConsumeGift(HttpRequest request, AppDbContext db, JwtTokenService jwtService)
    {
        try
        {
            var authHeader = request.Headers.Authorization.ToString();
    ...
    public async Task<IResult> GetRoomFilters(HttpRequest request, AppDbContext db)
    {
    ...
    public async Task<IResult> GetInteractionByMe(HttpRequest request, AppDbContext db, string id)
    {
        // TODO: implement
    ...
    public async Task<IResult> UploadSavedImage()
    {
        try
        {
